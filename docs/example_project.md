...
## Repository Link & Setup

You can browse the source code directly on GitHub:

**[View Example Project Source on GitHub](https://github.com/lucas-rollin/django-htmx-nav/tree/main/example)**

For detailed installation instructions, directory layout, and setup steps to run the example app locally, please refer to the [`example/README.md`](https://github.com/lucas-rollin/django-htmx-nav/tree/main/example/README.md) file in the repository.
