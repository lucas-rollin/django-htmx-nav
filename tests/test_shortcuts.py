...
from htmx_nav.partials import PathReplace
...
def test_render_nav_with_path_replace_htmx_resolves_and_renders():
    rf = RequestFactory()
    request = htmx_request(rf)
    transformer = PathReplace("_page.html", "_minimal.html")
...
def test_render_nav_with_path_replace_non_htmx_renders_full_page():
    rf = RequestFactory()
...
def test_render_nav_with_path_replace_in_settings():
    rf = RequestFactory()
    request = htmx_request(rf)
    transformer = PathReplace("_page.html", "_minimal.html")
